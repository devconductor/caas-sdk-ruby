...
# Unit tests for Pier::PessoaPersist
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PessoaPersist' do
  before do
    # run before each test
    @instance = Pier::PessoaPersist.new
  end
  ...
  describe 'test an instance of PessoaPersist' do
    it 'should create an instact of PessoaPersist' do
      @instance.should be_a(Pier::PessoaPersist) 
    end
  end
