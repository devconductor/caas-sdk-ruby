...
- Build date: 2016-10-28T17:25:14.058-03:00
...
*Pier::StatusContaApi* | [**listar_using_get4**](docs/StatusContaApi.md#listar_using_get4) | **GET** /api/status-contas | Lista os Status Contas cadastrados para o Emissor
...
*Pier::StatusImpressaoApi* | [**listar_using_get5**](docs/StatusImpressaoApi.md#listar_using_get5) | **GET** /api/status-impressoes | Lista as op\u00C3\u00A7\u00C3\u00B5es de Status Impress\u00C3\u00A3o
