...
module Pier
  ...
  class GlobaltagplataformamobileApi
    ...
    def atualizar_using_put1_with_http_info(id, update, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagplataformamobileApi.atualizar_using_put1 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagplataformamobileApi.atualizar_using_put1" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'update' when calling GlobaltagplataformamobileApi.atualizar_using_put1" if update.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagplataformamobileApi#atualizar_using_put1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def listar_using_get40_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagplataformamobileApi.listar_using_get40 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagplataformamobileApi#listar_using_get40\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post26_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagplataformamobileApi.salvar_using_post26 ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling GlobaltagplataformamobileApi.salvar_using_post26" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'PlataformaMobileResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagplataformamobileApi#salvar_using_post26\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
