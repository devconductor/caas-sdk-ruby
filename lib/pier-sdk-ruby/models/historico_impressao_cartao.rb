...
module Pier
  ...
  class HistoricoImpressaoCartao
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'idStatusImpressaoCartao']
        
        
        self.id_status_impressao_cartao = attributes[:'idStatusImpressaoCartao']
        
      
      end

      
      if attributes[:'mensagemHistorico']
        
        
        self.mensagem_historico = attributes[:'mensagemHistorico']
    ...
    def valid?
      ...
      if @id_status_impressao_cartao.nil?
        return false
      end
