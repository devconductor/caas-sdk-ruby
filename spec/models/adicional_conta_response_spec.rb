...
# Unit tests for Pier::AdicionalContaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdicionalContaResponse' do
  before do
    # run before each test
    @instance = Pier::AdicionalContaResponse.new
  end
  ...
  describe 'test an instance of AdicionalContaResponse' do
    it 'should create an instact of AdicionalContaResponse' do
      @instance.should be_a(Pier::AdicionalContaResponse) 
    end
  end
