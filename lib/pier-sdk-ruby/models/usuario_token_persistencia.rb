...
module Pier
  ...
  class UsuarioTokenPersistencia
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'enviaSMS']
        
        
        self.envia_sms = attributes[:'enviaSMS']
        
      
      end

      
      if attributes[:'idTemplateEmail']
        
        
        self.id_template_email = attributes[:'idTemplateEmail']
        
      
      end

      
      if attributes[:'idTemplateSMS']
        
        
        self.id_template_sms = attributes[:'idTemplateSMS']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          envia_sms == o.envia_sms &&
          id_template_email == o.id_template_email &&
          id_template_sms == o.id_template_sms &&
          nsu == o.nsu
    end
    ...
    def hash
      [cpf, email, ddd, telefone, data_nascimento, envia_sms, id_template_email, id_template_sms, nsu].hash
    end
