...
module Pier
  ...
  class AdicionalContaResponse
    ...
    def hash
      [id_conta, id_pessoa, nome, nome_impresso, numero_receita_federal, id_estado_civil, id_profissao, id_nacionalidade, id_parentesco, email, data_cadastro_portador].hash
    end
