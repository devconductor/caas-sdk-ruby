...
module Pier
  ...
  class HistoricoPagamentoResponse
    ...
    attr_accessor :data_vencimento_parcela_acordo
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'dataVencimentoParcelaAcordo']
        
        
        self.data_vencimento_parcela_acordo = attributes[:'dataVencimentoParcelaAcordo']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          data_vencimento_parcela_acordo == o.data_vencimento_parcela_acordo &&
          status == o.status
    end
    ...
    def hash
      [id_conta, id_pagamento, id_estabelecimento, id_banco, id_cartao, valor_pagamento, data_hora_pagamento, data_hora_entrada_pagamento, data_vencimento_parcela_acordo, status].hash
    end
