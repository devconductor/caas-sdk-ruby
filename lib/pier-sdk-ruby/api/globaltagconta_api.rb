...
module Pier
  class GlobaltagcontaApi
    ...
    def consultar_using_get16_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagcontaApi.consultar_using_get16 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagcontaApi.consultar_using_get16" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagcontaApi#consultar_using_get16\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def consultar_using_get51(id, id_transferencia, opts = {})
      data, _status_code, _headers = consultar_using_get51_with_http_info(id, id_transferencia, opts)
      return data
    end
    ...
    def consultar_using_get51_with_http_info(id, id_transferencia, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagcontaApi.consultar_using_get51 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagcontaApi.consultar_using_get51" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'id_transferencia' when calling GlobaltagcontaApi.consultar_using_get51" if id_transferencia.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagcontaApi#consultar_using_get51\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def criar_contas_multi_app_using_post_with_http_info(conta_multi_app_persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagcontaApi.criar_contas_multi_app_using_post ..."
      end
      
      
      # verify the required parameter 'conta_multi_app_persist' is set
      fail ArgumentError, "Missing the required parameter 'conta_multi_app_persist' when calling GlobaltagcontaApi.criar_contas_multi_app_using_post" if conta_multi_app_persist.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagcontaApi#criar_contas_multi_app_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get19_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagcontaApi.listar_using_get19 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagcontaApi#listar_using_get19\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get61(id, opts = {})
      data, _status_code, _headers = listar_using_get61_with_http_info(id, opts)
      return data
    end
    ...
    def listar_using_get61_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagcontaApi.listar_using_get61 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagcontaApi.listar_using_get61" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagcontaApi#listar_using_get61\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get63(id, opts = {})
      data, _status_code, _headers = listar_using_get63_with_http_info(id, opts)
      return data
    end
    ...
    def listar_using_get63_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagcontaApi.listar_using_get63 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagcontaApi.listar_using_get63" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagcontaApi#listar_using_get63\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ContaResponse]
    def salvar_using_post9(conta_persist, opts = {})
      data, _status_code, _headers = salvar_using_post9_with_http_info(conta_persist, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContaResponse, Fixnum, Hash)>] ContaResponse data, response status code and response headers
    def salvar_using_post9_with_http_info(conta_persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagcontaApi.salvar_using_post9 ..."
      end
      
      
      # verify the required parameter 'conta_persist' is set
      fail ArgumentError, "Missing the required parameter 'conta_persist' when calling GlobaltagcontaApi.salvar_using_post9" if conta_persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'ContaResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagcontaApi#salvar_using_post9\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
