...
module Pier
  ...
  class CredorDTO
    ...
    attr_accessor :id_pessoa_juridica
    ...
    attr_accessor :digito_verificador_agencia

    # C\u00C3\u00B3digo da Conta Corrente
    attr_accessor :conta_corrente

    # D\u00C3\u00ADgito Verificador da Conta Corrente
    attr_accessor :digito_verificador_conta_corrente
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'idPessoaJuridica']
        
        
        self.id_pessoa_juridica = attributes[:'idPessoaJuridica']
      ...
      if attributes[:'credorBanco']
        
        
        self.credor_banco = attributes[:'credorBanco']
      ...
      if attributes[:'digitoVerificadorAgencia']
        
        
        self.digito_verificador_agencia = attributes[:'digitoVerificadorAgencia']
      ...
      if attributes[:'digitoVerificadorContaCorrente']
        
        
        self.digito_verificador_conta_corrente = attributes[:'digitoVerificadorContaCorrente']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id_pessoa_juridica == o.id_pessoa_juridica &&
          nome == o.nome &&
          ...
          banco == o.banco &&
          agencia == o.agencia &&
          digito_verificador_agencia == o.digito_verificador_agencia &&
          conta_corrente == o.conta_corrente &&
          digito_verificador_conta_corrente == o.digito_verificador_conta_corrente
    end
    ...
    def hash
      [id_pessoa_juridica, nome, periodicidade, pagamento_semanal, pagamento_mensal, pagamento_decendial_primeiro, pagamento_decendial_segundo, pagamento_decendial_terceiro, pagamento_quinzenal_primeiro, pagamento_quinzenal_segundo, credor_banco, percentual_rav, recebe_rav, percentual_multiplica, taxa_adm, taxa_banco, limite_rav, id_credor_rav, banco, agencia, digito_verificador_agencia, conta_corrente, digito_verificador_conta_corrente].hash
    end
