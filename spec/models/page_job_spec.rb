...
# Unit tests for Pier::PageJob
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageJob' do
  before do
    # run before each test
    @instance = Pier::PageJob.new
  end
  ...
  describe 'test an instance of PageJob' do
    it 'should create an instact of PageJob' do
      @instance.should be_a(Pier::PageJob) 
    end
  end
