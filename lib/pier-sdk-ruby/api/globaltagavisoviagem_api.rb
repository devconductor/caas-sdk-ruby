  ...
  class GlobaltagavisoviagemApi
    ...
    def consultar_using_get8_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagavisoviagemApi.consultar_using_get8 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagavisoviagemApi.consultar_using_get8" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagavisoviagemApi#consultar_using_get8\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def listar_using_get9_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagavisoviagemApi.listar_using_get9 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagavisoviagemApi#listar_using_get9\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
