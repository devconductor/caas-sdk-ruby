...
- Build date: 2017-01-19T19:39:00.026-03:00
...
*Pier::ContaApi* | [**listar_faturas_using_get**](docs/ContaApi.md#listar_faturas_using_get) | **GET** /api/contas/{id_conta}/faturas | Listar Faturas da Conta
...
*Pier::ContaApi* | [**transacoes_using_post**](docs/ContaApi.md#transacoes_using_post) | **POST** /api/contas/{id_conta}/timeline | Permite listar uma linha do tempo com os eventos da conta
