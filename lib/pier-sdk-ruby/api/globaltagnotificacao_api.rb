...
module Pier
  class GlobaltagnotificacaoApi
    ...
    def alterar_template_notificacao_using_put_with_http_info(id, conteudo, opts = {})
      ...
      if opts[:'tipo_layout'] && !['RECUPERAR_SENHA', 'FATURA_POR_EMAIL', 'VALIDAR_DISPOSITIVO', 'NOTIFICACAO_EMAIL', 'OTP_3D_SECURE'].include?(opts[:'tipo_layout'])
        fail ArgumentError, 'invalid value for "tipo_layout", must be one of RECUPERAR_SENHA, FATURA_POR_EMAIL, VALIDAR_DISPOSITIVO, NOTIFICACAO_EMAIL, OTP_3D_SECURE'
      end
      ...
      if opts[:'tipo_notificacao'] && !['SMS', 'PUSH_APNS', 'PUSH_FCM', 'PUSH_GCM', 'WEBHOOK', 'EMAIL'].include?(opts[:'tipo_notificacao'])
        fail ArgumentError, 'invalid value for "tipo_notificacao", must be one of SMS, PUSH_APNS, PUSH_FCM, PUSH_GCM, WEBHOOK, EMAIL'
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def enviar_otp_using_post(secure3d_request, opts = {})
      data, _status_code, _headers = enviar_otp_using_post_with_http_info(secure3d_request, opts)
      return data
    end
    ...
    def enviar_otp_using_post_with_http_info(secure3d_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagnotificacaoApi.enviar_otp_using_post ..."
      end
      
      
      # verify the required parameter 'secure3d_request' is set
      fail ArgumentError, "Missing the required parameter 'secure3d_request' when calling GlobaltagnotificacaoApi.enviar_otp_using_post" if secure3d_request.nil?
      ...
      # resource path
      local_var_path = "/api/notificacoes/3d-secure".sub('{format}','json')
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(secure3d_request)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Object')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagnotificacaoApi#enviar_otp_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
