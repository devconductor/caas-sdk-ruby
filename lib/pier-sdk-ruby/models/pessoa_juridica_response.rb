...
module Pier
  ...
  class PessoaJuridicaResponse
    ...
    def hash
      [id, razao_social, cnpj, inscricao_estadual, contato, banco, agencia, digito_verificador_agencia, conta_corrente, digito_verificador_conta_corrente, usuario].hash
    end
