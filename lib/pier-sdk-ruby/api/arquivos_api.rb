  ...
  class ArquivosApi
    ...
    def consultar_using_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArquivosApi.consultar_using_get ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling ArquivosApi.consultar_using_get" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArquivosApi#consultar_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def salvar_using_post1_with_http_info(arquivo_persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArquivosApi.salvar_using_post1 ..."
      end
      
      
      # verify the required parameter 'arquivo_persist' is set
      fail ArgumentError, "Missing the required parameter 'arquivo_persist' when calling ArquivosApi.salvar_using_post1" if arquivo_persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'ArquivoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArquivosApi#salvar_using_post1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
