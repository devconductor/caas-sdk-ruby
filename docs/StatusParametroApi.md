...
[**listar_using_get31**](StatusParametroApi.md#listar_using_get31) | **GET** /api/status-contas | Lista os Status Contas cadastrados para o Emissor
...
begin
  ...
  puts "Exception when calling StatusParametroApi->listar_using_get32: #{e}"
end
```
