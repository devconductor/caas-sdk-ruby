...
module Pier
  ...
  class TransacaoOnUsPorIdCartaoRequest
    ...
    def hash
      [nsu_origem, codigo_processamento, valor_transacao, numero_estabelecimento, data_hora_terminal, terminal_requisitante, numero_parcelas].hash
    end
