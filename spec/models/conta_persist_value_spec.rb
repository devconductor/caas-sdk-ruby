...
# Unit tests for Pier::ContaPersistValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContaPersistValue' do
  before do
    # run before each test
    @instance = Pier::ContaPersistValue.new
  end
  ...
  describe 'test an instance of ContaPersistValue' do
    it 'should create an instact of ContaPersistValue' do
      @instance.should be_a(Pier::ContaPersistValue) 
    end
  end
  ...
  describe 'test attribute "flag_fatura_por_email"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
