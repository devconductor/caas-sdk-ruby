...
module Pier
  ...
  class SocioAprovadoPersistValue
    ...
    def hash
      [nome, cpf, data_nascimento, sexo, numero_identidade, orgao_expedidor_identidade, unidade_federativa_identidade, data_emissao_identidade, estado_civil, profissao, nacionalidade, email, telefones].hash
    end
