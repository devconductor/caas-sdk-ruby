...
# Unit tests for Pier::Estabelecimento
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Estabelecimento' do
  before do
    # run before each test
    @instance = Pier::Estabelecimento.new
  end
  ...
  describe 'test an instance of Estabelecimento' do
    it 'should create an instact of Estabelecimento' do
      @instance.should be_a(Pier::Estabelecimento) 
    end
  end
