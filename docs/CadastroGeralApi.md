...
[**consultar_using_get13**](CadastroGeralApi.md#consultar_using_get13) | **GET** /api/produtos/{id} | Apresenta os dados de um determinado Produto
[**consultar_using_get19**](CadastroGeralApi.md#consultar_using_get19) | **GET** /api/tipos-ajustes | Lista os tipos de ajustes do emissor 
...
[**listar_using_get18**](CadastroGeralApi.md#listar_using_get18) | **GET** /api/portadores | Lista os Portadores existentes
[**listar_using_get19**](CadastroGeralApi.md#listar_using_get19) | **GET** /api/produtos | Lista os Produtos do Emissor
[**listar_using_get2**](CadastroGeralApi.md#listar_using_get2) | **GET** /api/atendimento-clientes | Lista todos os atendimentos
[**listar_using_get20**](CadastroGeralApi.md#listar_using_get20) | **GET** /api/promotores | Lista promotores cadastrados na base do emissor
[**listar_using_get26**](CadastroGeralApi.md#listar_using_get26) | **GET** /api/tipos-enderecos | Lista as op\u00C3\u00B5es de Tipos de Endere\u00C3\u00A7os do Emissor 
[**listar_using_get28**](CadastroGeralApi.md#listar_using_get28) | **GET** /api/tipos-telefones | Lista os Tipos de Telefones
[**listar_using_get3**](CadastroGeralApi.md#listar_using_get3) | **GET** /api/bancos | Lista os Bancos cadastrados para o Emissor
[**listar_using_get33**](CadastroGeralApi.md#listar_using_get33) | **GET** /api/vencimentos | Listar Vencimentos
...
> ProdutoDetalhesResponse consultar_using_get13(id)
...
begin
  ...
  puts "Exception when calling CadastroGeralApi->consultar_using_get13: #{e}"
end
```
...
> PageTipoAjusteResponse consultar_using_get19(opts)
...
begin
  ...
  puts "Exception when calling CadastroGeralApi->consultar_using_get19: #{e}"
end
```
...
> PageTipoBoletoResponse consultar_using_get20(opts)
...
> TipoEnderecoResponse consultar_using_get21(id)
...
begin
  ...
  puts "Exception when calling CadastroGeralApi->listar_using_get18: #{e}"
end
```
