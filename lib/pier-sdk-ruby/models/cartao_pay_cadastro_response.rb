...
module Pier
  ...
  class CartaoPayCadastroResponse
    ...
    def hash
      [id, numero_cartao, data_validade_cartao, nome_impresso, id_entidade, nome_entidade, status, data_validade_chave_criptograma, cvv, chave_criptograma].hash
    end
