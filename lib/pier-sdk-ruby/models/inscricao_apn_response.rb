...
module Pier
  ...
  class InscricaoAPNResponse
    # {{{inscricao_apn_resposta_aplicacao_mobile_descricao}}}
    attr_accessor :aplicacao_mobile
    ...
    attr_accessor :data_desativacao
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'aplicacaoMobile']
        
        
        self.aplicacao_mobile = attributes[:'aplicacaoMobile']
      ...
      if attributes[:'dataCriacao']
        
        
        self.data_criacao = attributes[:'dataCriacao']
        
      
      end

      
      if attributes[:'dataDesativacao']
        
        
        self.data_desativacao = attributes[:'dataDesativacao']
        
      
      end

      
      if attributes[:'deviceToken']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          aplicacao_mobile == o.aplicacao_mobile &&
          ativo == o.ativo &&
          cartao == o.cartao &&
          data_criacao == o.data_criacao &&
          data_desativacao == o.data_desativacao &&
    ...
    def hash
      [aplicacao_mobile, ativo, cartao, data_criacao, data_desativacao, device_token, id].hash
    end
