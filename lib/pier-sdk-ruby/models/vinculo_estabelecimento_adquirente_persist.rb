...
module Pier
  ...
  class VinculoEstabelecimentoAdquirentePersist
    ...
    def valid?
      ...
      if @codigo_estabelecimento_adquirente.nil?
        return false
      end
    ...
    def hash
      [id_estabelecimento, id_adquirente, codigo_estabelecimento_adquirente].hash
    end
