...
module Pier
  ...
  class CartaoMultiAppImpressaoResponse
    # {{{cartao_impressao_multiapp_response_cartao_pai_value}}}
    attr_accessor :cartao_pai
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'cartaoPai']
        
        
        self.cartao_pai = attributes[:'cartaoPai']
