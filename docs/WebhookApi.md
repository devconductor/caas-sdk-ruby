...
[**consultar_using_get33**](WebhookApi.md#consultar_using_get33) | **GET** /api/webhooks/{id} | Consultar Webhook
[**listar_using_get38**](WebhookApi.md#listar_using_get38) | **GET** /api/webhooks | Lista os Webhooks
[**salvar_using_post21**](WebhookApi.md#salvar_using_post21) | **POST** /api/webhooks | Salvar Webhook
...
> WebHookResponse consultar_using_get33(id)
...
begin
  ...
  puts "Exception when calling WebhookApi->consultar_using_get33: #{e}"
end
```
...
# **listar_using_get38**
> PageWebHookResponse listar_using_get38(opts)
...
begin
  ...
  puts "Exception when calling WebhookApi->listar_using_get38: #{e}"
end
```
...
# **salvar_using_post21**
> WebHookResponse salvar_using_post21(tipo_evento, url)
...
begin
  #Salvar Webhook
  result = api_instance.salvar_using_post21(tipo_evento, url)
  p result
rescue Pier::ApiError => e
  puts "Exception when calling WebhookApi->salvar_using_post21: #{e}"
end
```
