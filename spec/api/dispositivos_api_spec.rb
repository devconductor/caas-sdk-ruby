...
# Unit tests for Pier::DispositivosApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DispositivosApi' do
  before do
    # run before each test
    @instance = Pier::DispositivosApi.new
  end
  ...
  describe 'test an instance of DispositivosApi' do
    it 'should create an instact of DispositivosApi' do
      @instance.should be_a(Pier::DispositivosApi)
    end
  end
