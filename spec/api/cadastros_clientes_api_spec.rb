...
# Unit tests for Pier::CadastrosClientesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CadastrosClientesApi' do
  before do
    # run before each test
    @instance = Pier::CadastrosClientesApi.new
  end
  ...
  describe 'test an instance of CadastrosClientesApi' do
    it 'should create an instact of CadastrosClientesApi' do
      @instance.should be_a(Pier::CadastrosClientesApi)
    end
  end
