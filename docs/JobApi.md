...
# **salvar_using_post15**
> JobResponse salvar_using_post15(descricao, cron, groovy)
...
begin
  #Cadastrar Job
  result = api_instance.salvar_using_post15(descricao, cron, groovy)
  p result
rescue Pier::ApiError => e
  puts "Exception when calling JobApi->salvar_using_post15: #{e}"
end
```
