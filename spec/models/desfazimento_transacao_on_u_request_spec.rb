...
# Unit tests for Pier::DesfazimentoTransacaoOnURequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DesfazimentoTransacaoOnURequest' do
  before do
    # run before each test
    @instance = Pier::DesfazimentoTransacaoOnURequest.new
  end
  ...
  describe 'test an instance of DesfazimentoTransacaoOnURequest' do
    it 'should create an instact of DesfazimentoTransacaoOnURequest' do
      @instance.should be_a(Pier::DesfazimentoTransacaoOnURequest) 
    end
  end
