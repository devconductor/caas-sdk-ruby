...
module Pier
  ...
  class ReferenciaComercialAprovadoPersistValue
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'nomeContrato']
        
        
        self.nome_contrato = attributes[:'nomeContrato']
    ...
    def hash
      [razao_social, nome_contrato, ddd, telefone, email].hash
    end
