...
# Unit tests for Pier::DadosCarto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DadosCarto' do
  before do
    # run before each test
    @instance = Pier::DadosCarto.new
  end
  ...
  describe 'test an instance of DadosCarto' do
    it 'should create an instact of DadosCarto' do
      @instance.should be_a(Pier::DadosCarto) 
    end
  end
