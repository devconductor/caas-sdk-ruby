...
module Pier
  ...
  class DesfazimentoTransacaoOnUsRequest
    ...
    def hash
      [nsu_origem, nsu_origem_transacao_cancelada, codigo_processamento, data_hora_transacao_cancelada, valor_transacao, numero_real_cartao, data_validade_cartao, numero_estabelecimento, data_hora_terminal, terminal_requisitante].hash
    end
