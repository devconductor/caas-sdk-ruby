...
# Unit tests for Pier::SocioAprovadoPersistValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SocioAprovadoPersistValue' do
  before do
    # run before each test
    @instance = Pier::SocioAprovadoPersistValue.new
  end
  ...
  describe 'test an instance of SocioAprovadoPersistValue' do
    it 'should create an instact of SocioAprovadoPersistValue' do
      @instance.should be_a(Pier::SocioAprovadoPersistValue) 
    end
  end
