...
module Pier
  ...
  class PermissaoPaisApi
    ...
    def listar_paises_using_get_with_http_info(opts = {})
      ...
      if opts[:'continente'] && !['AFRICA', 'AMERICA_LATINA', 'AMERICA_NORTE', 'ASIA', 'EUROPA', 'OCEANIA'].include?(opts[:'continente'])
        fail ArgumentError, 'invalid value for "continente", must be one of AFRICA, AMERICA_LATINA, AMERICA_NORTE, ASIA, EUROPA, OCEANIA'
      end
