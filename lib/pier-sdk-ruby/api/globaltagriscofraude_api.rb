  ...
  class GlobaltagriscofraudeApi
    ...
    def consultar_using_get37_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagriscofraudeApi.consultar_using_get37 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagriscofraudeApi.consultar_using_get37" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagriscofraudeApi#consultar_using_get37\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
