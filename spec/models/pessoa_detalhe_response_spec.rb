...
# Unit tests for Pier::PessoaDetalheResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PessoaDetalheResponse' do
  before do
    # run before each test
    @instance = Pier::PessoaDetalheResponse.new
  end
  ...
  describe 'test an instance of PessoaDetalheResponse' do
    it 'should create an instact of PessoaDetalheResponse' do
      @instance.should be_a(Pier::PessoaDetalheResponse) 
    end
  end
