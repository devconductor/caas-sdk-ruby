...
module Pier
  ...
  class UsuarioldapUpdateObjectDescription
    ...
    def self.swagger_types
      {
        ...
        :'perfis' => :'Array<ReferenciaIdPersist>',
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'perfis']
        
        if (value = attributes[:'perfis']).is_a?(Array)
          self.perfis = value
        end
    ...
    def hash
      [nome, login, cpf, email, perfis, status].hash
    end
