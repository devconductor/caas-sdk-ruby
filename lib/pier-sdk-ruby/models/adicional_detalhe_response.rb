...
module Pier
  ...
  class AdicionalDetalheResponse
    ...
    def hash
      [id_conta, id_pessoa, nome, nome_impresso, numero_receita_federal, data_nascimento, sexo, numero_identidade, orgao_expedidor_identidade, unidade_federativa_identidade, data_emissao_identidade, id_estado_civil, id_profissao, id_nacionalidade, id_parentesco, email, flag_ativo, data_cadastro_portador, data_cancelamento_portador, telefones].hash
    end
