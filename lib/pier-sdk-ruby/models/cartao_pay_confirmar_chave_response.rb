...
module Pier
  ...
  class CartaoPayConfirmarChaveResponse
    # Id do cart\u00C3\u00A3o
    attr_accessor :id
    ...
    attr_accessor :chave_criptograma
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'chaveCriptograma']
        
        
        self.chave_criptograma = attributes[:'chaveCriptograma']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          chave_criptograma == o.chave_criptograma
    end
    ...
    def hash
      [id, numero_cartao, data_validade_cartao, nome_impresso, id_entidade, nome_entidade, status, data_validade_chave_criptograma, chave_criptograma].hash
    end
