...
# Unit tests for Pier::StatusCarto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusCarto' do
  before do
    # run before each test
    @instance = Pier::StatusCarto.new
  end
  ...
  describe 'test an instance of StatusCarto' do
    it 'should create an instact of StatusCarto' do
      @instance.should be_a(Pier::StatusCarto) 
    end
  end
