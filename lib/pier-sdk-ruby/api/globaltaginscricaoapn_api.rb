...
module Pier
  class GlobaltaginscricaoapnApi
    ...
    def listar_using_get31_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltaginscricaoapnApi.listar_using_get31 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltaginscricaoapnApi#listar_using_get31\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post15(inscricao_persist, opts = {})
      data, _status_code, _headers = salvar_using_post15_with_http_info(inscricao_persist, opts)
      return data
    end
    ...
    def salvar_using_post15_with_http_info(inscricao_persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltaginscricaoapnApi.salvar_using_post15 ..."
      end
      
      
      # verify the required parameter 'inscricao_persist' is set
      fail ArgumentError, "Missing the required parameter 'inscricao_persist' when calling GlobaltaginscricaoapnApi.salvar_using_post15" if inscricao_persist.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltaginscricaoapnApi#salvar_using_post15\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
