...
module Pier
  ...
  class ControleVencimentoResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'dataPrevistaCorte']
        
        
        self.data_prevista_corte = attributes[:'dataPrevistaCorte']
        
      
      end

      
      if attributes[:'dataHoraRealizacaoCorte']
        
        
        self.data_hora_realizacao_corte = attributes[:'dataHoraRealizacaoCorte']
        
      
      end

      
      if attributes[:'dataPrevistaFaturamento']
        
        
        self.data_prevista_faturamento = attributes[:'dataPrevistaFaturamento']
        
      
      end

      
      if attributes[:'dataHoraRealizacaoFaturamento']
        
        
        self.data_hora_realizacao_faturamento = attributes[:'dataHoraRealizacaoFaturamento']
        
      
      end

      
      if attributes[:'dataRealVencimento']
        
        
        self.data_real_vencimento = attributes[:'dataRealVencimento']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          data_prevista_corte == o.data_prevista_corte &&
          data_hora_realizacao_corte == o.data_hora_realizacao_corte &&
          data_prevista_faturamento == o.data_prevista_faturamento &&
          data_hora_realizacao_faturamento == o.data_hora_realizacao_faturamento &&
          data_real_vencimento == o.data_real_vencimento
    end
    ...
    def hash
      [data_vencimento, data_prevista_corte, data_hora_realizacao_corte, data_prevista_faturamento, data_hora_realizacao_faturamento, data_real_vencimento].hash
    end
