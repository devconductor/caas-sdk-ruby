...
------------- | ------------- | -------------
[**consultar_using_get15**](RiscoFraudeApi.md#consultar_using_get15) | **GET** /api/riscos-fraudes/{id} | Consultar uma transa\u00C3\u00A7\u00C3\u00A3o classificada com risco de fraude
...
> RiscoFraudeDetalhadoResponse consultar_using_get15(id)
...
begin
  ...
  puts "Exception when calling RiscoFraudeApi->consultar_using_get15: #{e}"
end
```
