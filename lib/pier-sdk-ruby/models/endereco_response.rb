...
module Pier
  ...
  class EnderecoResponse
    ...
    attr_accessor :flag_correspondencia
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'flagCorrespondencia']
        
        
        self.flag_correspondencia = attributes[:'flagCorrespondencia']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flag_correspondencia == o.flag_correspondencia
    end
    ...
    def hash
      [id, id_pessoa, id_tipo_endereco, cep, logradouro, numero, complemento, ponto_referencia, bairro, cidade, uf, pais, data_inclusao, data_ultima_atualizacao, flag_correspondencia].hash
    end
