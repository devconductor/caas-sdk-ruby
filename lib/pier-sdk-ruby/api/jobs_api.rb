...
module Pier
  ...
  class JobsApi
    ...
    def ativar_job_using_post_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling JobsApi.ativar_job_using_post" if id.nil?
    ...
    def atualizar_using_put_with_http_info(id, descricao, cron, groovy, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling JobsApi.atualizar_using_put" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'descricao' when calling JobsApi.atualizar_using_put" if descricao.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'cron' when calling JobsApi.atualizar_using_put" if cron.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'groovy' when calling JobsApi.atualizar_using_put" if groovy.nil?
    ...
    def desativar_job_using_post_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling JobsApi.desativar_job_using_post" if id.nil?
