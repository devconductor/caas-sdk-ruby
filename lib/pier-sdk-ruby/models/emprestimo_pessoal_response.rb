...
module Pier
  ...
  class EmprestimoPessoalResponse
    ...
    def self.swagger_types
      {
        ...
        :'planos_parcelamentos' => :'Array<PlanoParcelamentoEmprestimoResponse>',
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'planosParcelamentos']
        
        if (value = attributes[:'planosParcelamentos']).is_a?(Array)
          self.planos_parcelamentos = value
        end
      ...
      if attributes[:'valorSolicitado']
        
        
        self.valor_solicitado = attributes[:'valorSolicitado']
      ...
      if attributes[:'periodoTaxa']
        
        
        self.periodo_taxa = attributes[:'periodoTaxa']
