...
[**consultar_using_get29**](ContaApi.md#consultar_using_get29) | **GET** /api/contas/{id}/transferencias-creditos-contas-bancarias/{id_transferencia} | Consultar uma transfer\u00C3\u00AAncia banc\u00C3\u00A1ria para um banco
[**consultar_using_get30**](ContaApi.md#consultar_using_get30) | **GET** /api/contas/{id}/transferencias-creditos-cartoes/{id_transferencia} | Consulta os detalhes de uma determinada transfer\u00C3\u00AAncia
...
[**listar_using_get33**](ContaApi.md#listar_using_get33) | **GET** /api/contas/{id}/transferencias-creditos-contas-bancarias | Listar as transfer\u00C3\u00AAncias banc\u00C3\u00A1rias realizadas
[**listar_using_get34**](ContaApi.md#listar_using_get34) | **GET** /api/contas/{id}/transferencias-creditos-cartoes | Lista as transfer\u00C3\u00AAncias realizadas pela conta
...
> TransferenciaBancariaResponse consultar_using_get29(id, id_transferencia, opts)
...
begin
  #Consultar uma transfer\u00C3\u00AAncia banc\u00C3\u00A1ria para um banco
  result = api_instance.consultar_using_get29(id, id_transferencia, opts)
  p result
rescue Pier::ApiError => e
  puts "Exception when calling ContaApi->consultar_using_get29: #{e}"
end
```
...
> TransferenciaDetalheResponse consultar_using_get30(id, id_transferencia)
...
begin
  #Consulta os detalhes de uma determinada transfer\u00C3\u00AAncia
  result = api_instance.consultar_using_get30(id, id_transferencia)
  p result
rescue Pier::ApiError => e
...
# **listar_using_get33**
> PageTransferenciaBancariaResponse listar_using_get33(id, opts)
...
begin
  #Listar as transfer\u00C3\u00AAncias banc\u00C3\u00A1rias realizadas
  result = api_instance.listar_using_get33(id, opts)
  p result
rescue Pier::ApiError => e
  puts "Exception when calling ContaApi->listar_using_get33: #{e}"
end
```
...
# **listar_using_get34**
> PageTransferenciaResponse listar_using_get34(id, opts)
