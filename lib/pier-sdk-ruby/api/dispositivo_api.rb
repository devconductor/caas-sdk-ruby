  ...
  class DispositivoApi
    ...
    def ativar_using_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DispositivoApi.ativar_using_post ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling DispositivoApi.ativar_using_post" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DispositivoApi#ativar_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def desativar_using_post_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DispositivoApi.desativar_using_post ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling DispositivoApi.desativar_using_post" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'DispositivoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DispositivoApi#desativar_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get9_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DispositivoApi.listar_using_get9 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DispositivoApi#listar_using_get9\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post4_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DispositivoApi.salvar_using_post4 ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling DispositivoApi.salvar_using_post4" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'DispositivoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DispositivoApi#salvar_using_post4\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
