...
# Unit tests for Pier::DadosCartaoResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DadosCartaoResponse' do
  before do
    # run before each test
    @instance = Pier::DadosCartaoResponse.new
  end
  ...
  describe 'test an instance of DadosCartaoResponse' do
    it 'should create an instact of DadosCartaoResponse' do
      @instance.should be_a(Pier::DadosCartaoResponse) 
    end
  end
