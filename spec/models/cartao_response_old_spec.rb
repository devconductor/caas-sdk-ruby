...
# Unit tests for Pier::CartaoResponseOld
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CartaoResponseOld' do
  before do
    # run before each test
    @instance = Pier::CartaoResponseOld.new
  end
  ...
  describe 'test an instance of CartaoResponseOld' do
    it 'should create an instact of CartaoResponseOld' do
      @instance.should be_a(Pier::CartaoResponseOld) 
    end
  end
