...
module Pier
  class GlobaltaglimitedisponibilidadeApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [LimiteDisponibilidadeResponse]
    def consultar_using_get25(id_conta, opts = {})
      data, _status_code, _headers = consultar_using_get25_with_http_info(id_conta, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(LimiteDisponibilidadeResponse, Fixnum, Hash)>] LimiteDisponibilidadeResponse data, response status code and response headers
    def consultar_using_get25_with_http_info(id_conta, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltaglimitedisponibilidadeApi.consultar_using_get25 ..."
      end
      
      
      # verify the required parameter 'id_conta' is set
      fail ArgumentError, "Missing the required parameter 'id_conta' when calling GlobaltaglimitedisponibilidadeApi.consultar_using_get25" if id_conta.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'LimiteDisponibilidadeResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltaglimitedisponibilidadeApi#consultar_using_get25\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [LimiteDisponibilidadeResponse]
    def sensibilizar_saldo_disponivel_global_using_post(id, sensibilizar_saldo_global, opts = {})
      data, _status_code, _headers = sensibilizar_saldo_disponivel_global_using_post_with_http_info(id, sensibilizar_saldo_global, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(LimiteDisponibilidadeResponse, Fixnum, Hash)>] LimiteDisponibilidadeResponse data, response status code and response headers
    def sensibilizar_saldo_disponivel_global_using_post_with_http_info(id, sensibilizar_saldo_global, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltaglimitedisponibilidadeApi.sensibilizar_saldo_disponivel_global_using_post ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltaglimitedisponibilidadeApi.sensibilizar_saldo_disponivel_global_using_post" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'sensibilizar_saldo_global' when calling GlobaltaglimitedisponibilidadeApi.sensibilizar_saldo_disponivel_global_using_post" if sensibilizar_saldo_global.nil?
      ...
      # resource path
      local_var_path = "/api/contas/{id}/limites-disponibilidades/sensibilizar-saldo-disponivel-global".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(sensibilizar_saldo_global)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'LimiteDisponibilidadeResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltaglimitedisponibilidadeApi#sensibilizar_saldo_disponivel_global_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
