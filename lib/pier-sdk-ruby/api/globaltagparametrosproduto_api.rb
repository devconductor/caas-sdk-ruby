  ...
  class GlobaltagparametrosprodutoApi
    ...
    def listar_using_get37_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagparametrosprodutoApi.listar_using_get37 ..."
      end
      ...
      # resource path
      local_var_path = "/api/parametros-produto".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagparametrosprodutoApi#listar_using_get37\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
