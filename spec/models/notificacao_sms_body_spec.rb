...
# Unit tests for Pier::NotificacaoSMSBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificacaoSMSBody' do
  before do
    # run before each test
    @instance = Pier::NotificacaoSMSBody.new
  end
  ...
  describe 'test an instance of NotificacaoSMSBody' do
    it 'should create an instact of NotificacaoSMSBody' do
      @instance.should be_a(Pier::NotificacaoSMSBody) 
    end
  end
