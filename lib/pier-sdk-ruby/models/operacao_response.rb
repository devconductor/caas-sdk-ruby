...
module Pier
  ...
  class OperacaoResponse
    ...
    def hash
      [id_operacao, codigo_processamento, codigo_processamento_cancelamento, nome_operacao, flag_cobra_juros, flag_cobra_tarifa, carencia, flag_permitir_parcelamento].hash
    end
