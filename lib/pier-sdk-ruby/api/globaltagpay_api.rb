...
module Pier
  class GlobaltagpayApi
    ...
    def atualizar_using_put1(device_id, id, update, opts = {})
      data, _status_code, _headers = atualizar_using_put1_with_http_info(device_id, id, update, opts)
      return data
    end
    ...
    def atualizar_using_put1_with_http_info(device_id, id, update, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagpayApi.atualizar_using_put1 ..."
      end
      
      
      # verify the required parameter 'device_id' is set
      fail ArgumentError, "Missing the required parameter 'device_id' when calling GlobaltagpayApi.atualizar_using_put1" if device_id.nil?
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagpayApi.atualizar_using_put1" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'update' when calling GlobaltagpayApi.atualizar_using_put1" if update.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagpayApi#atualizar_using_put1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def consultar_using_get11(device_id, id, opts = {})
      data, _status_code, _headers = consultar_using_get11_with_http_info(device_id, id, opts)
      return data
    end
    ...
    def consultar_using_get11_with_http_info(device_id, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagpayApi.consultar_using_get11 ..."
      end
      
      
      # verify the required parameter 'device_id' is set
      fail ArgumentError, "Missing the required parameter 'device_id' when calling GlobaltagpayApi.consultar_using_get11" if device_id.nil?
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagpayApi.consultar_using_get11" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagpayApi#consultar_using_get11\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get11_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagpayApi.listar_using_get11 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagpayApi#listar_using_get11\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post6_with_http_info(device_id, persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagpayApi.salvar_using_post6 ..."
      end
      
      
      # verify the required parameter 'device_id' is set
      fail ArgumentError, "Missing the required parameter 'device_id' when calling GlobaltagpayApi.salvar_using_post6" if device_id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'persist' when calling GlobaltagpayApi.salvar_using_post6" if persist.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagpayApi#salvar_using_post6\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
