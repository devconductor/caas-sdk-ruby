...
# Unit tests for Pier::CompraResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CompraResponse' do
  before do
    # run before each test
    @instance = Pier::CompraResponse.new
  end
  ...
  describe 'test an instance of CompraResponse' do
    it 'should create an instact of CompraResponse' do
      @instance.should be_a(Pier::CompraResponse) 
    end
  end
  ...
  describe 'test attribute "valor_total_compra"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "primeira_parcela"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
  ...
  describe 'test attribute "numero_parcelas_antecipaveis"' do
    it 'should work' do
       # assertion here
       # should be_a()
       # should be_nil
