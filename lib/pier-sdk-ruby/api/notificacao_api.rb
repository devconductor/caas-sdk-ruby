  ...
  class NotificacaoApi
    ...
    def alterar_configuracao_using_put_with_http_info(id, persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.alterar_configuracao_using_put ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling NotificacaoApi.alterar_configuracao_using_put" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'persist' when calling NotificacaoApi.alterar_configuracao_using_put" if persist.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#alterar_configuracao_using_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def alterar_template_notificacao_using_put_with_http_info(id, conteudo, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling NotificacaoApi.alterar_template_notificacao_using_put" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'conteudo' when calling NotificacaoApi.alterar_template_notificacao_using_put" if conteudo.nil?
    ...
    def atualizar_sms_using_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.atualizar_sms_using_post ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#atualizar_sms_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def consultar_configuracao_using_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.consultar_configuracao_using_get ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling NotificacaoApi.consultar_configuracao_using_get" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ConfiguracaoEmailResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#consultar_configuracao_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def consultar_template_notificacao_using_get_with_http_info(id, opts = {})
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling NotificacaoApi.consultar_template_notificacao_using_get" if id.nil?
    ...
    def listar_configuracao_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.listar_configuracao_using_get ..."
      end
    ...
    def listar_push_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.listar_push_using_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#listar_push_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_sms_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.listar_sms_using_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#listar_sms_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_template_notificacao_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.listar_template_notificacao_using_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#listar_template_notificacao_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_tipos_layouts_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.listar_tipos_layouts_using_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#listar_tipos_layouts_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_configuracao_using_post_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.salvar_configuracao_using_post ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling NotificacaoApi.salvar_configuracao_using_post" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'ConfiguracaoEmailResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#salvar_configuracao_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_push_fcm_using_post_with_http_info(push_persists, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.salvar_push_fcm_using_post ..."
      end
      
      
      # verify the required parameter 'push_persists' is set
      fail ArgumentError, "Missing the required parameter 'push_persists' when calling NotificacaoApi.salvar_push_fcm_using_post" if push_persists.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#salvar_push_fcm_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_push_gcm_using_post_with_http_info(push_persists, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.salvar_push_gcm_using_post ..."
      end
      
      
      # verify the required parameter 'push_persists' is set
      fail ArgumentError, "Missing the required parameter 'push_persists' when calling NotificacaoApi.salvar_push_gcm_using_post" if push_persists.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'NotificacaoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#salvar_push_gcm_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_push_using_post_with_http_info(push_persists, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.salvar_push_using_post ..."
      end
      
      
      # verify the required parameter 'push_persists' is set
      fail ArgumentError, "Missing the required parameter 'push_persists' when calling NotificacaoApi.salvar_push_using_post" if push_persists.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'NotificacaoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#salvar_push_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_sms_using_post_with_http_info(lista_sms, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NotificacaoApi.salvar_sms_using_post ..."
      end
      
      
      # verify the required parameter 'lista_sms' is set
      fail ArgumentError, "Missing the required parameter 'lista_sms' when calling NotificacaoApi.salvar_sms_using_post" if lista_sms.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'NotificacaoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: NotificacaoApi#salvar_sms_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_template_notificacao_using_post_with_http_info(conteudo, opts = {})
      ...
      # verify the required parameter 'conteudo' is set
      fail ArgumentError, "Missing the required parameter 'conteudo' when calling NotificacaoApi.salvar_template_notificacao_using_post" if conteudo.nil?
