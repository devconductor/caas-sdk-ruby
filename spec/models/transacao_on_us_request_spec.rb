...
# Unit tests for Pier::TransacaoOnUsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TransacaoOnUsRequest' do
  before do
    # run before each test
    @instance = Pier::TransacaoOnUsRequest.new
  end
  ...
  describe 'test an instance of TransacaoOnUsRequest' do
    it 'should create an instact of TransacaoOnUsRequest' do
      @instance.should be_a(Pier::TransacaoOnUsRequest) 
    end
  end
