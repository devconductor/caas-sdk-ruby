...
module Pier
  ...
  class StatusParametrosApi
    ...
    def listar_using_get22_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: StatusParametrosApi.listar_using_get22 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StatusParametrosApi#listar_using_get22\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get23_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: StatusParametrosApi.listar_using_get23 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StatusParametrosApi#listar_using_get23\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
