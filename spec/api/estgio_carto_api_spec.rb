...
# Unit tests for Pier::EstgioCartoApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EstgioCartoApi' do
  before do
    # run before each test
    @instance = Pier::EstgioCartoApi.new
  end
  ...
  describe 'test an instance of EstgioCartoApi' do
    it 'should create an instact of EstgioCartoApi' do
      @instance.should be_a(Pier::EstgioCartoApi)
    end
  end
