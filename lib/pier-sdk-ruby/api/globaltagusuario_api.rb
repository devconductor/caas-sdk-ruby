...
module Pier
  ...
  class GlobaltagusuarioApi
    ...
    def atualizar_using_put2(update, opts = {})
      data, _status_code, _headers = atualizar_using_put2_with_http_info(update, opts)
      return data
    end
    ...
    def atualizar_using_put2_with_http_info(update, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagusuarioApi.atualizar_using_put2 ..."
      end
      
      
      # verify the required parameter 'update' is set
      fail ArgumentError, "Missing the required parameter 'update' when calling GlobaltagusuarioApi.atualizar_using_put2" if update.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagusuarioApi#atualizar_using_put2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get62(opts = {})
      data, _status_code, _headers = listar_using_get62_with_http_info(opts)
      return data
    end
    ...
    def listar_using_get62_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagusuarioApi.listar_using_get62 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagusuarioApi#listar_using_get62\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post33_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagusuarioApi.salvar_using_post33 ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling GlobaltagusuarioApi.salvar_using_post33" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'UsuarioResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagusuarioApi#salvar_using_post33\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post9_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagusuarioApi.salvar_using_post9 ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling GlobaltagusuarioApi.salvar_using_post9" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'ControleSegurancaDispositivoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagusuarioApi#salvar_using_post9\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
