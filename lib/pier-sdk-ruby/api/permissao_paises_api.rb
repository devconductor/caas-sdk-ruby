  ...
  class PermissaoPaisesApi
    ...
    def consultar_pais_using_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PermissaoPaisesApi.consultar_pais_using_get ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling PermissaoPaisesApi.consultar_pais_using_get" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PermissaoPaisesApi#consultar_pais_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def listar_continentes_using_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PermissaoPaisesApi.listar_continentes_using_get ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PermissaoPaisesApi#listar_continentes_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_paises_using_get_with_http_info(opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PermissaoPaisesApi#listar_paises_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
