...
module Pier
  ...
  class UsuarioResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'bloquearAcesso']
        
        
        self.bloquear_acesso = attributes[:'bloquearAcesso']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bloquear_acesso == o.bloquear_acesso
    end
    ...
    def hash
      [id, nome, login, id_emissor, cpf, email, status, data_criacao, data_modificacao, tentativas_incorretas, bloquear_acesso].hash
    end
