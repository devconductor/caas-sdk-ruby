  ...
  class AntecipacoesApi
    ...
    def configurar_taxa_antecipacao_using_post_with_http_info(id, taxa_antecipacao_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AntecipacoesApi.configurar_taxa_antecipacao_using_post ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AntecipacoesApi.configurar_taxa_antecipacao_using_post" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'taxa_antecipacao_request' when calling AntecipacoesApi.configurar_taxa_antecipacao_using_post" if taxa_antecipacao_request.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AntecipacoesApi#configurar_taxa_antecipacao_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def consultar_taxa_antecipacao_using_get_with_http_info(id, tipo_transacao, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AntecipacoesApi.consultar_taxa_antecipacao_using_get ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AntecipacoesApi.consultar_taxa_antecipacao_using_get" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'tipo_transacao' when calling AntecipacoesApi.consultar_taxa_antecipacao_using_get" if tipo_transacao.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ParametroProdutoResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AntecipacoesApi#consultar_taxa_antecipacao_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def efetivar_antecipacao_using_post_with_http_info(id_conta, id, quantidade_parcelas, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AntecipacoesApi.efetivar_antecipacao_using_post ..."
      end
      
      
      # verify the required parameter 'id_conta' is set
      fail ArgumentError, "Missing the required parameter 'id_conta' when calling AntecipacoesApi.efetivar_antecipacao_using_post" if id_conta.nil?
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AntecipacoesApi.efetivar_antecipacao_using_post" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'quantidade_parcelas' when calling AntecipacoesApi.efetivar_antecipacao_using_post" if quantidade_parcelas.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AntecipacoesApi#efetivar_antecipacao_using_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def simular_antecipacao_using_get_with_http_info(id_conta, id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: AntecipacoesApi.simular_antecipacao_using_get ..."
      end
      
      
      # verify the required parameter 'id_conta' is set
      fail ArgumentError, "Missing the required parameter 'id_conta' when calling AntecipacoesApi.simular_antecipacao_using_get" if id_conta.nil?
      ...
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling AntecipacoesApi.simular_antecipacao_using_get" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AntecipacoesApi#simular_antecipacao_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
