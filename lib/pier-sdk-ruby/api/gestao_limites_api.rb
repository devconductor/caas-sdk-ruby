...
module Pier
  ...
  class GestaoLimitesApi
    ...
    def alterar_limite_using_put_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling GestaoLimitesApi.alterar_limite_using_put" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GestaoLimitesApi#alterar_limite_using_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def consultar_limite_disponibilidade_using_get1_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GestaoLimitesApi.consultar_limite_disponibilidade_using_get1 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GestaoLimitesApi.consultar_limite_disponibilidade_using_get1" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'LimiteDisponibilidadeResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GestaoLimitesApi#consultar_limite_disponibilidade_using_get1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_historico_alteracoes_limites_using_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GestaoLimitesApi.listar_historico_alteracoes_limites_using_get ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GestaoLimitesApi.listar_historico_alteracoes_limites_using_get" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GestaoLimitesApi#listar_historico_alteracoes_limites_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
