...
# Unit tests for Pier::SMSPersistValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SMSPersistValue' do
  before do
    # run before each test
    @instance = Pier::SMSPersistValue.new
  end
  ...
  describe 'test an instance of SMSPersistValue' do
    it 'should create an instact of SMSPersistValue' do
      @instance.should be_a(Pier::SMSPersistValue) 
    end
  end
