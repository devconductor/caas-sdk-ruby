...
module Pier
  ...
  class BasePartialUpdateValue
    ...
    def hash
      [servidor, usuario, senha, nome_base, alterado_por, domain, senha_criptografada, nome_base_controle_acesso, id_emissor, servidor_controle_acesso, nome_base_usuarios, servidor_usuarios, flag_cluster].hash
    end
