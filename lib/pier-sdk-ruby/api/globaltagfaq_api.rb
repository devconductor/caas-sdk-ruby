...
module Pier
  class GlobaltagfaqApi
    ...
    def consultar_using_get23_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagfaqApi.consultar_using_get23 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagfaqApi.consultar_using_get23" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'FaqResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagfaqApi#consultar_using_get23\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get27_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagfaqApi.listar_using_get27 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagfaqApi#listar_using_get27\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
