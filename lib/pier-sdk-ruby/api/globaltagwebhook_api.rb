...
module Pier
  class GlobaltagwebhookApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [WebHookResponse]
    def consultar_using_get55(id, opts = {})
      data, _status_code, _headers = consultar_using_get55_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebHookResponse, Fixnum, Hash)>] WebHookResponse data, response status code and response headers
    def consultar_using_get55_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagwebhookApi.consultar_using_get55 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagwebhookApi.consultar_using_get55" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'WebHookResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagwebhookApi#consultar_using_get55\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get69(opts = {})
      data, _status_code, _headers = listar_using_get69_with_http_info(opts)
      return data
    end
    ...
    def listar_using_get69_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagwebhookApi.listar_using_get69 ..."
      end
      ...
      if opts[:'tipo_evento'] && !['RISCO_FRAUDE', 'CODIGO_SEGURANCA', 'OUTROS', 'OTP_3D_SECURE'].include?(opts[:'tipo_evento'])
        fail ArgumentError, 'invalid value for "tipo_evento", must be one of RISCO_FRAUDE, CODIGO_SEGURANCA, OUTROS, OTP_3D_SECURE'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagwebhookApi#listar_using_get69\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [WebHookResponse]
    def salvar_using_post36(webhook, opts = {})
      data, _status_code, _headers = salvar_using_post36_with_http_info(webhook, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebHookResponse, Fixnum, Hash)>] WebHookResponse data, response status code and response headers
    def salvar_using_post36_with_http_info(webhook, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagwebhookApi.salvar_using_post36 ..."
      end
      
      
      # verify the required parameter 'webhook' is set
      fail ArgumentError, "Missing the required parameter 'webhook' when calling GlobaltagwebhookApi.salvar_using_post36" if webhook.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'WebHookResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagwebhookApi#salvar_using_post36\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
