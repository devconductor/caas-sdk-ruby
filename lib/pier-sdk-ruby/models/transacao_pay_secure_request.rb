...
module Pier
  ...
  class TransacaoPaySecureRequest
    ...
    def hash
      [data_hora_transacao, numero_cartao, id_cartao, valor, nsu_origem, nome_portador_cartao, origem, terminal_requisitante, codigo_processamento, data_validade_cartao, numero_estabelecimento, numero_parcelas, codigo_seguranca_cartao, sort].hash
    end
