...
------------- | ------------- | -------------
[**alterar_limite_using_put**](LimiteApi.md#alterar_limite_using_put) | **PUT** /api/contas/{id}/alterar-limites | Realiza a altera\u00C3\u00A7\u00C3\u00A3o dos limites da conta
[**consultar_limite_disponibilidade_using_get1**](LimiteApi.md#consultar_limite_disponibilidade_using_get1) | **GET** /api/contas/{id}/limites-disponibilidades | Apresenta os limites da conta
...
begin
  ...
  puts "Exception when calling LimiteApi->alterar_limite_using_put: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling LimiteApi->consultar_limite_disponibilidade_using_get1: #{e}"
end
```
