...
module Pier
  ...
  class IntegrarDocumentoRequest
    ...
    def self.swagger_types
      {
        ...
        :'propriedades' => :'Array<PropriedadeDocumentoRequest>'
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'idTemplate']
        
        
        self.id_template = attributes[:'idTemplate']
      ...
      if attributes[:'propriedades']
        
        if (value = attributes[:'propriedades']).is_a?(Array)
          self.propriedades = value
        end
    ...
    def hash
      [id_template, arquivo, nome, propriedades].hash
    end
