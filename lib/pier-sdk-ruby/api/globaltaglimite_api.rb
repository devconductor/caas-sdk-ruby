  ...
  class GlobaltaglimiteApi
    ...
    def listar_historico_alteracoes_limites_using_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltaglimiteApi.listar_historico_alteracoes_limites_using_get ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltaglimiteApi.listar_historico_alteracoes_limites_using_get" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltaglimiteApi#listar_historico_alteracoes_limites_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
