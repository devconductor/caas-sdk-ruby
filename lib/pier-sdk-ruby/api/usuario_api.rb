...
module Pier
  ...
  class UsuarioApi
    ...
    def alterar_using_put11(id, update, opts = {})
      data, _status_code, _headers = alterar_using_put11_with_http_info(id, update, opts)
      return data
    end
    ...
    def alterar_using_put11_with_http_info(id, update, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsuarioApi.alterar_using_put11 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UsuarioApi.alterar_using_put11" if id.nil?
      ...
      fail ArgumentError, "Missing the required parameter 'update' when calling UsuarioApi.alterar_using_put11" if update.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsuarioApi#alterar_using_put11\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def consultar_using_get32_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsuarioApi.consultar_using_get32 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling UsuarioApi.consultar_using_get32" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'UsuarioResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsuarioApi#consultar_using_get32\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get36_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsuarioApi.listar_using_get36 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsuarioApi#listar_using_get36\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UsuarioResponse]
    def salvar_using_post20(persist, opts = {})
      data, _status_code, _headers = salvar_using_post20_with_http_info(persist, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UsuarioResponse, Fixnum, Hash)>] UsuarioResponse data, response status code and response headers
    def salvar_using_post20_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: UsuarioApi.salvar_using_post20 ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling UsuarioApi.salvar_using_post20" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'UsuarioResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsuarioApi#salvar_using_post20\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
