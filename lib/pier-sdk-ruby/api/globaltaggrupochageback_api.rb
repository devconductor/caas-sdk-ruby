...
module Pier
  ...
  class GlobaltaggrupochagebackApi
    ...
    def listar_codigos_using_get(id, opts = {})
      data, _status_code, _headers = listar_codigos_using_get_with_http_info(id, opts)
      return data
    end
    ...
    def listar_codigos_using_get_with_http_info(id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltaggrupochagebackApi.listar_codigos_using_get" if id.nil?
      ...
      # resource path
      local_var_path = "/api/grupos-chargeback/{id}/codigos".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
      ...
      query_params[:'idBandeira'] = opts[:'id_bandeira'] if opts[:'id_bandeira']
    ...
    def listar_using_get27_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltaggrupochagebackApi.listar_using_get27 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltaggrupochagebackApi#listar_using_get27\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
