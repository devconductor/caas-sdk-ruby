...
module Pier
  class GlobaltagplataformamobileApi
    ...
    def listar_using_get42_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagplataformamobileApi.listar_using_get42 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagplataformamobileApi#listar_using_get42\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post27_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagplataformamobileApi.salvar_using_post27 ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling GlobaltagplataformamobileApi.salvar_using_post27" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'PlataformaMobileResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagplataformamobileApi#salvar_using_post27\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
