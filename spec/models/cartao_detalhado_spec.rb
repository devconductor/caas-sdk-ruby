...
# Unit tests for Pier::CartaoDetalhado
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CartaoDetalhado' do
  before do
    # run before each test
    @instance = Pier::CartaoDetalhado.new
  end
  ...
  describe 'test an instance of CartaoDetalhado' do
    it 'should create an instact of CartaoDetalhado' do
      @instance.should be_a(Pier::CartaoDetalhado) 
    end
  end
