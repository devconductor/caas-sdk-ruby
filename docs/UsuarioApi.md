...
[**consultar_using_get31**](UsuarioApi.md#consultar_using_get31) | **GET** /api/usuarios/{id} | Apresenta os dados de um determinado Usu\u00C3\u00A1rio na base do PIER ou WS.
...
[**listar_using_get35**](UsuarioApi.md#listar_using_get35) | **GET** /api/usuarios | Lista os Usu\u00C3\u00A1rios cadastrados na base do PIER ou WS.
...
> UsuarioResponse consultar_using_get31(id)
...
begin
  ...
  puts "Exception when calling UsuarioApi->consultar_using_get31: #{e}"
end
```
...
# **listar_using_get35**
> PageUsuarioResponse listar_using_get35(opts)
...
begin
  ...
  puts "Exception when calling UsuarioApi->listar_using_get35: #{e}"
end
```
