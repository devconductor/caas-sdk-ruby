...
module Pier
  class GlobaltagantecipacaoApi
    ...
    def listar_using_get14(id_conta, opts = {})
      data, _status_code, _headers = listar_using_get14_with_http_info(id_conta, opts)
      return data
    end
    ...
    def listar_using_get14_with_http_info(id_conta, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagantecipacaoApi.listar_using_get14 ..."
      end
      
      
      # verify the required parameter 'id_conta' is set
      fail ArgumentError, "Missing the required parameter 'id_conta' when calling GlobaltagantecipacaoApi.listar_using_get14" if id_conta.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagantecipacaoApi#listar_using_get14\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
