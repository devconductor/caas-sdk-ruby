...
module Pier
  ...
  class LimiteDisponibilidadeApi
    ...
    def alterar_using_put7(id_conta, opts = {})
      data, _status_code, _headers = alterar_using_put7_with_http_info(id_conta, opts)
      return data
    end
    ...
    def alterar_using_put7_with_http_info(id_conta, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LimiteDisponibilidadeApi.alterar_using_put7 ..."
      end
      
      
      # verify the required parameter 'id_conta' is set
      fail ArgumentError, "Missing the required parameter 'id_conta' when calling LimiteDisponibilidadeApi.alterar_using_put7" if id_conta.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LimiteDisponibilidadeApi#alterar_using_put7\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [LimiteDisponibilidadeResponse]
    def consultar_using_get16(id_conta, opts = {})
      data, _status_code, _headers = consultar_using_get16_with_http_info(id_conta, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(LimiteDisponibilidadeResponse, Fixnum, Hash)>] LimiteDisponibilidadeResponse data, response status code and response headers
    def consultar_using_get16_with_http_info(id_conta, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LimiteDisponibilidadeApi.consultar_using_get16 ..."
      end
      
      
      # verify the required parameter 'id_conta' is set
      fail ArgumentError, "Missing the required parameter 'id_conta' when calling LimiteDisponibilidadeApi.consultar_using_get16" if id_conta.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'LimiteDisponibilidadeResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LimiteDisponibilidadeApi#consultar_using_get16\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
