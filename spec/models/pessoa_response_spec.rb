...
# Unit tests for Pier::PessoaResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PessoaResponse' do
  before do
    # run before each test
    @instance = Pier::PessoaResponse.new
  end
  ...
  describe 'test an instance of PessoaResponse' do
    it 'should create an instact of PessoaResponse' do
      @instance.should be_a(Pier::PessoaResponse) 
    end
  end
