...
[**salvar_using_post16**](UsuarioApi.md#salvar_using_post16) | **POST** /api/usuarios | Cadastra Usu\u00C3\u00A1rio na base do PIER ou WS.
...
begin
  ...
  puts "Exception when calling UsuarioApi->listar_using_get32: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling UsuarioApi->salvar_using_post16: #{e}"
end
```
