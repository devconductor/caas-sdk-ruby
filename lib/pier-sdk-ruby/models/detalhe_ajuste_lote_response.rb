...
module Pier
  ...
  class DetalheAjusteLoteResponse
    ...
    attr_accessor :valor_total_transacao
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'arquivoId']
        
        
        self.arquivo_id = attributes[:'arquivoId']
        
      
      end

      
      if attributes[:'tipoAjusteDescricao']
        
        
        self.tipo_ajuste_descricao = attributes[:'tipoAjusteDescricao']
      ...
      if attributes[:'valorTotalTransacao']
        
        
        self.valor_total_transacao = attributes[:'valorTotalTransacao']
      ...
      if attributes[:'numeroLinha']
        
        
        self.numero_linha = attributes[:'numeroLinha']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          arquivo_id == o.arquivo_id &&
          tipo_ajuste_descricao == o.tipo_ajuste_descricao &&
          id_conta == o.id_conta &&
          status == o.status &&
          data_transacao == o.data_transacao &&
          valor_total_transacao == o.valor_total_transacao &&
          tipo_operacao == o.tipo_operacao &&
          data_processamento == o.data_processamento &&
          numero_linha == o.numero_linha &&
    ...
    def hash
      [id, arquivo_id, tipo_ajuste_descricao, id_conta, status, data_transacao, valor_total_transacao, tipo_operacao, data_processamento, numero_linha, descricao_status].hash
    end
