...
module Pier
  ...
  class ConfiguracaoRegistroCobrancaPersist
    ...
    def hash
      [codigo_banco, uri, key_store_name, key_store_password, keystore_alias, key_store_private_key_password, type_keystore, trust_store_name, trust_store_password, truststore_alias, type_truststore, uri_adicional, status].hash
    end
