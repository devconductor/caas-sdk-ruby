  ...
  class EnderecosNacionaisApi
    ...
    def consultar_endereco_using_get_with_http_info(cep, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: EnderecosNacionaisApi.consultar_endereco_using_get ..."
      end
      
      
      # verify the required parameter 'cep' is set
      fail ArgumentError, "Missing the required parameter 'cep' when calling EnderecosNacionaisApi.consultar_endereco_using_get" if cep.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnderecosNacionaisApi#consultar_endereco_using_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
