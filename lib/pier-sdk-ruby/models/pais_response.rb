...
module Pier
  ...
  class PaisResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'continente']
        
        
        self.continente = attributes[:'continente']
    ...
    def valid?
      ...
      if @continente && !allowed_values.include?(@continente)
        return false
      end
    ...
    # @param [Object] continente Object to be assigned
    def continente=(continente)
      allowed_values = ["AFRICA", "AMERICA_LATINA", "AMERICA_NORTE", "ASIA", "ANTARTIDA", "EUROPA", "OCEANIA"]
      if continente && !allowed_values.include?(continente)
        fail ArgumentError, "invalid value for 'continente', must be one of #{allowed_values}."
      end
      @continente = continente
    end
    ...
    def hash
      [id, codigo, sigla, descricao, continente, flag_ativo].hash
    end
