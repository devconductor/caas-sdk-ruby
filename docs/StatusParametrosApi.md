...
[**listar_using_get22**](StatusParametrosApi.md#listar_using_get22) | **GET** /api/status-contas | Lista os Status Contas cadastrados para o Emissor
[**listar_using_get23**](StatusParametrosApi.md#listar_using_get23) | **GET** /api/status-impressoes | Lista as op\u00C3\u00A7\u00C3\u00B5es de Status Impress\u00C3\u00A3o
...
begin
  ...
  puts "Exception when calling StatusParametrosApi->listar_using_get22: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling StatusParametrosApi->listar_using_get23: #{e}"
end
```
