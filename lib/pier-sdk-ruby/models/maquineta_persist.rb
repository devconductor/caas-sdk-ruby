...
module Pier
  ...
  class MaquinetaPersist
    # {{{maquineta_persist_id_terminal_value}}}
    attr_accessor :id_terminal
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'idTerminal']
        
        
        self.id_terminal = attributes[:'idTerminal']
    ...
    def hash
      [id_terminal, id_tipo_maquineta, valor, data_hora_implantacao].hash
    end
