...
module Pier
  ...
  class TransacaoOnUsResponse
    ...
    def self.swagger_types
      {
        ...
        :'plano_de_parcelamento' => :'Array<MapOfstringAndstring>',
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'planoDeParcelamento']
        
        if (value = attributes[:'planoDeParcelamento']).is_a?(Array)
          self.plano_de_parcelamento = value
        end
