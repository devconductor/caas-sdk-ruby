  ...
  class RiscoFraudeApi
    ...
    def consultar_using_get24_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RiscoFraudeApi.consultar_using_get24 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling RiscoFraudeApi.consultar_using_get24" if id.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RiscoFraudeApi#consultar_using_get24\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
