...
# Unit tests for Pier::PageSMS
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PageSMS' do
  before do
    # run before each test
    @instance = Pier::PageSMS.new
  end
  ...
  describe 'test an instance of PageSMS' do
    it 'should create an instact of PageSMS' do
      @instance.should be_a(Pier::PageSMS) 
    end
  end
