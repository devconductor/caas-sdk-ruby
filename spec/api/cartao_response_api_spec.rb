...
# Unit tests for Pier::CartaoResponseApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CartaoResponseApi' do
  before do
    # run before each test
    @instance = Pier::CartaoResponseApi.new
  end
  ...
  describe 'test an instance of CartaoResponseApi' do
    it 'should create an instact of CartaoResponseApi' do
      @instance.should be_a(Pier::CartaoResponseApi)
    end
  end
