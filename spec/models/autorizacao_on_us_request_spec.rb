...
# Unit tests for Pier::AutorizacaoOnUsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AutorizacaoOnUsRequest' do
  before do
    # run before each test
    @instance = Pier::AutorizacaoOnUsRequest.new
  end
  ...
  describe 'test an instance of AutorizacaoOnUsRequest' do
    it 'should create an instact of AutorizacaoOnUsRequest' do
      @instance.should be_a(Pier::AutorizacaoOnUsRequest) 
    end
  end
