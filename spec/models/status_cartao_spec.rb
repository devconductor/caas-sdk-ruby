...
# Unit tests for Pier::StatusCartao
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StatusCartao' do
  before do
    # run before each test
    @instance = Pier::StatusCartao.new
  end
  ...
  describe 'test an instance of StatusCartao' do
    it 'should create an instact of StatusCartao' do
      @instance.should be_a(Pier::StatusCartao) 
    end
  end
