...
module Pier
  ...
  class ParametroProdutoResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'valorParametro']
        
        
        self.valor_parametro = attributes[:'valorParametro']
    ...
    def hash
      [id, id_produto, tipo_origem_transacao, descricao, valor_parametro, data_validade].hash
    end
