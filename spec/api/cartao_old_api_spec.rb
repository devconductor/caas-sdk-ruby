...
# Unit tests for Pier::CartaoOldApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CartaoOldApi' do
  before do
    # run before each test
    @instance = Pier::CartaoOldApi.new
  end
  ...
  describe 'test an instance of CartaoOldApi' do
    it 'should create an instact of CartaoOldApi' do
      @instance.should be_a(Pier::CartaoOldApi)
    end
  end
  ...
  # unit tests for embossado_cartao_using_put
  # Embossado
  ...
  describe 'embossado_cartao_using_put test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
