...
module Pier
  ...
  class GlobaltagdebitorecorrenteApi
    ...
    def listar_using_get17(id_conta, opts = {})
      data, _status_code, _headers = listar_using_get17_with_http_info(id_conta, opts)
      return data
    end
    ...
    def listar_using_get17_with_http_info(id_conta, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagdebitorecorrenteApi.listar_using_get17 ..."
      end
      
      
      # verify the required parameter 'id_conta' is set
      fail ArgumentError, "Missing the required parameter 'id_conta' when calling GlobaltagdebitorecorrenteApi.listar_using_get17" if id_conta.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagdebitorecorrenteApi#listar_using_get17\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def listar_using_get53_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagdebitorecorrenteApi.listar_using_get53 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagdebitorecorrenteApi#listar_using_get53\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
