...
module Pier
  ...
  class CredorResponse
    ...
    def hash
      [id, id_pessoa_juridica, nome, periodicidade, pagamento_semanal, pagamento_mensal, pagamento_decendial_primeiro, pagamento_decendial_segundo, pagamento_decendial_terceiro, pagamento_quinzenal_primeiro, pagamento_quinzenal_segundo, credor_banco, percentual_rav, recebe_rav, percentual_multiplica, taxa_adm, taxa_banco, limite_rav, id_credor_rav, banco, agencia, digito_verificador_agencia, conta_corrente, digito_verificador_conta_corrente, usuario].hash
    end
