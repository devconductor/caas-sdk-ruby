...
module Pier
  ...
  class AutorizacaoOnUsRequest
    ...
    def hash
      [nsu_origem, numero_parcelas, codigo_processamento, codigo_seguranca_cartao, valor_transacao, numero_real_cartao, data_validade_cartao, numero_estabelecimento, data_hora_terminal, terminal_requisitante].hash
    end
