...
module Pier
  ...
  class ContaPersistValue
    ...
    attr_accessor :flag_fatura_por_email
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'flagFaturaPorEmail']
        
        
        self.flag_fatura_por_email = attributes[:'flagFaturaPorEmail']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          flag_fatura_por_email == o.flag_fatura_por_email
    end
    ...
    def hash
      [id_pessoa, id_origem_comercial, id_produto, dia_vencimento, valor_renda, canal_entrada, valor_pontuacao, id_endereco_correspondencia, limite_global, limite_maximo, limite_parcelas, limite_consignado, flag_fatura_por_email].hash
    end
