  ...
  class GlobaltagboletoApi
    ...
    def consultar_using_get36_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagboletoApi.consultar_using_get36 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagboletoApi.consultar_using_get36" if id.nil?
      ...
      # query parameters
      query_params = {}
      query_params[:'zeraValorCodigoBarras'] = opts[:'zera_valor_codigo_barras'] if opts[:'zera_valor_codigo_barras']
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagboletoApi#consultar_using_get36\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def listar_using_get47_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagboletoApi.listar_using_get47 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagboletoApi#listar_using_get47\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
