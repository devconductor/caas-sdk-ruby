...
module Pier
  ...
  class PlataformaMobileApi
    ...
    def listar_using_get19_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PlataformaMobileApi.listar_using_get19 ..."
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlataformaMobileApi#listar_using_get19\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def salvar_using_post14_with_http_info(persist, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PlataformaMobileApi.salvar_using_post14 ..."
      end
      
      
      # verify the required parameter 'persist' is set
      fail ArgumentError, "Missing the required parameter 'persist' when calling PlataformaMobileApi.salvar_using_post14" if persist.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'PlataformaMobileResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PlataformaMobileApi#salvar_using_post14\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
