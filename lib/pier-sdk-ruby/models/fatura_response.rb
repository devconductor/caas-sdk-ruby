...
module Pier
  ...
  class FaturaResponse
    ...
    def hash
      [id_conta, situacao_processamento, pagamento_efetuado, data_vencimento_fatura, data_vencimento_real, data_fechamento, valor_total, valor_pagamento_minimo].hash
    end
