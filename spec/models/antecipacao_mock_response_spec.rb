...
# Unit tests for Pier::AntecipacaoMockResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AntecipacaoMockResponse' do
  before do
    # run before each test
    @instance = Pier::AntecipacaoMockResponse.new
  end
  ...
  describe 'test an instance of AntecipacaoMockResponse' do
    it 'should create an instact of AntecipacaoMockResponse' do
      @instance.should be_a(Pier::AntecipacaoMockResponse) 
    end
  end
