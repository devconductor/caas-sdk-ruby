...
module Pier
  ...
  class GlobaltagarquivoApi
    ...
    # @option opts [Integer] :limit Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
    # @return [PageArquivoAUDResponse]
    def listar_using_get5(id, opts = {})
      data, _status_code, _headers = listar_using_get5_with_http_info(id, opts)
      return data
    end
    ...
    # @option opts [Integer] :limit Limite de elementos por solicita\u00E7\u00E3o (Default = 50, Max = 50)
    # @return [Array<(PageArquivoAUDResponse, Fixnum, Hash)>] PageArquivoAUDResponse data, response status code and response headers
    def listar_using_get5_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: GlobaltagarquivoApi.listar_using_get5 ..."
      end
      
      
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling GlobaltagarquivoApi.listar_using_get5" if id.nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'PageArquivoAUDResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GlobaltagarquivoApi#listar_using_get5\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
