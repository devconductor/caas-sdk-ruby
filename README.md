...
- Build date: 2017-02-16T18:35:00.932-03:00
...
```shell
gem install ./pier-sdk-ruby-2.5.5.gem
```
(for development, run `gem install --dev ./pier-sdk-ruby-2.5.5.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'pier-sdk-ruby', '~> 2.5.5'
