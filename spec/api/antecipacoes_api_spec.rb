...
# Unit tests for Pier::AntecipacoesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AntecipacoesApi' do
  before do
    # run before each test
    @instance = Pier::AntecipacoesApi.new
  end
  ...
  describe 'test an instance of AntecipacoesApi' do
    it 'should create an instact of AntecipacoesApi' do
      @instance.should be_a(Pier::AntecipacoesApi)
    end
  end
