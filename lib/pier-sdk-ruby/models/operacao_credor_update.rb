...
module Pier
  ...
  class OperacaoCredorUpdate
    ...
    def hash
      [id_operacao, id_credor, id_produto, remuneracao_percentual, remuneracao_fixa, periodicidade, vencimento_primeira_parcela, dias_afastamento, fator_multiplicador, flag_taxa_fixada, plano_minimo, plano_maximo].hash
    end
