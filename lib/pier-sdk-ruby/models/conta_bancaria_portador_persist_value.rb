...
module Pier
  ...
  class ContaBancariaPortadorPersistValue
    ...
    def hash
      [id_conta, nome_agencia, banco, numero_agencia, digito_agencia, numero_conta, digito_conta, flag_ativo, flag_conta_origem_doc, id_pessoa_fisica, flag_conta_poupanca, favorecido, numero_receira_federal, titularidade].hash
    end
