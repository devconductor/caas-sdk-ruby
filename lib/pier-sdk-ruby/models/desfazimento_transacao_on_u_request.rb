...
module Pier
  ...
  class DesfazimentoTransacaoOnURequest
    ...
    def hash
      [nsu_origem, codigo_processamento, valor_transacao, numero_real_cartao, data_validade_cartao, numero_estabelecimento, data_hora_terminal, terminal_requisitante, nsu_origem_transacao_cancelada, data_hora_transacao_cancelada, codigo_transacao_cancelada].hash
    end
