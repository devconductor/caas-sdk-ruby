...
module Pier
  ...
  class PlanoParcelamentoTransferenciaCreditoContaBancariaRequest
    ...
    def hash
      [nsu_origem, valor_transacao, numero_real_cartao, data_validade_cartao, numero_meses_carencia, numero_estabelecimento, data_hora_terminal, terminal_requisitante].hash
    end
