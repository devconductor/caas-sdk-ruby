...
module Pier
  ...
  class TokenPartialUpdateValue
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'criadoPor']
        
        
        self.criado_por = attributes[:'criadoPor']
        
      
      end

      
      if attributes[:'alteradoPor']
        
        
        self.alterado_por = attributes[:'alteradoPor']
        
      
      end

      
      if attributes[:'idAplicacao']
        
        
        self.id_aplicacao = attributes[:'idAplicacao']
    ...
    def hash
      [base, owner, criado_por, alterado_por, id_aplicacao].hash
    end
