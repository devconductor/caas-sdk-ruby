...
module Pier
  class JobApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [JobResponse]
    def salvar_using_post15(descricao, cron, groovy, opts = {})
      data, _status_code, _headers = salvar_using_post15_with_http_info(descricao, cron, groovy, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(JobResponse, Fixnum, Hash)>] JobResponse data, response status code and response headers
    def salvar_using_post15_with_http_info(descricao, cron, groovy, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: JobApi.salvar_using_post15 ..."
      end
      
      
      # verify the required parameter 'descricao' is set
      fail ArgumentError, "Missing the required parameter 'descricao' when calling JobApi.salvar_using_post15" if descricao.nil?
      ...
      # verify the required parameter 'cron' is set
      fail ArgumentError, "Missing the required parameter 'cron' when calling JobApi.salvar_using_post15" if cron.nil?
      ...
      # verify the required parameter 'groovy' is set
      fail ArgumentError, "Missing the required parameter 'groovy' when calling JobApi.salvar_using_post15" if groovy.nil?
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'JobResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: JobApi#salvar_using_post15\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
