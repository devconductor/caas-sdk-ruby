...
describe 'GlobaltagwebhookApi' do
  ...
  # unit tests for listar_using_get69
  ...
  describe 'listar_using_get69 test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
  ...
  # unit tests for salvar_using_post36
  # {{{web_hook_resource_salvar}}}
  # {{{web_hook_resource_salvar_notes}}}
  # @param webhook webhook
  # @param [Hash] opts the optional parameters
  # @return [WebHookResponse]
  describe 'salvar_using_post36 test' do
    it "should work" do
      # assertion here
      # should be_a()
      # should be_nil
