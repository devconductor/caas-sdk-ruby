...
module Pier
  ...
  class StatusCartoApi
    ...
    def listar_status_cartoes_using_get_with_http_info(opts = {})
      ...
      query_params[:'cancela_conta'] = opts[:'cancela_conta'] if opts[:'cancela_conta']
      query_params[:'permite_desbloqueio'] = opts[:'permite_desbloqueio'] if opts[:'permite_desbloqueio']
