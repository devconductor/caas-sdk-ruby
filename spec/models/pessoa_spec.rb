...
# Unit tests for Pier::Pessoa
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Pessoa' do
  before do
    # run before each test
    @instance = Pier::Pessoa.new
  end
  ...
  describe 'test an instance of Pessoa' do
    it 'should create an instact of Pessoa' do
      @instance.should be_a(Pier::Pessoa) 
    end
  end
