...
module Pier
  ...
  class EnderecoAprovadoPersistValue
    ...
    def hash
      [id_tipo_endereco, cep, logradouro, numero, complemento, ponto_referencia, bairro, cidade, uf, pais, endereco_correspondencia].hash
    end
