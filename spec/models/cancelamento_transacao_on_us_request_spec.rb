...
# Unit tests for Pier::CancelamentoTransacaoOnUsRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CancelamentoTransacaoOnUsRequest' do
  before do
    # run before each test
    @instance = Pier::CancelamentoTransacaoOnUsRequest.new
  end
  ...
  describe 'test an instance of CancelamentoTransacaoOnUsRequest' do
    it 'should create an instact of CancelamentoTransacaoOnUsRequest' do
      @instance.should be_a(Pier::CancelamentoTransacaoOnUsRequest) 
    end
  end
